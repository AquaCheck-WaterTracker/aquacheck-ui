...
function Goal() {
    return (
        <div className="flex flex-col py-10 ml-10 mr-10">
            ...
            <h3 className="text-xl py-2">General recommendations:</h3>
            <ul className="">
 ...
 <section className="pt-20 pb-10 lg:pt-[120px] lg:pb-20">
     <div className="container mx-auto">
          ...
          <div>
            ...
            Exercising helps you stay healthy and strong
                <Link to='https://familydoctor.org/hydration-why-its-so-important/'></Link>
            </h3>
      ...
      <div className="w-full px-4 md:w-1/2 lg:w-1/3">
        <div className="mx-auto mb-10 max-w-[370px]">
          ...
          <div>
            ...
            <Link to='https://www.medicalnewstoday.com/articles/291683'></Link>
            </h3>
            <p className="text-body-color text-base">
      ...
      <div className="w-full px-4 md:w-1/2 lg:w-1/3">
        <div className="mx-auto mb-10 max-w-[370px]">
          ...
          <div>
            ...
            <h3 className="text-dark hover:text-primary mb-4 inline-block text-xl font-semibold sm:text-2xl lg:text-xl xl:text-2xl"> Do diet sodas raise insulin levels?
            <Link to='https://www.medicalnewstoday.com/articles/291683https://www.medicalnewstoday.com/articles/both-diet-and-regular-soda-may-increase-insulin-levels'></Link>
            </h3>
            <p className="text-body-color text-base">
